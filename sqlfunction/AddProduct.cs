...
namespace sqlfunction
{
    public static class AddProduct
    {
        ...
        {
            string connectionString = "Server=tcp:sqldatabase22.database.windows.net,1433;Initial Catalog=sqladmin;Persist Security Info=False;User ID=sqladmin;Password=Fahadzunera123;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;\";";
